...
List<MovieModel> movieList = [
  ...
  MovieModel(
    ...
    rating: 9.3,
    synopsis:
        "Andy Dufresne, a banker wrongly convicted of murder, is sentenced to life in Shawshank prison. Over the years, he befriends fellow inmate Red and earns the trust of the warden. But Andy has a secret plan that could lead to freedom.",
    imgUrl:
  ...
  MovieModel(
    ...
    rating: 8.6,
    synopsis:
        "In a dystopian future where Earth is slowly becoming uninhabitable, a group of astronauts embarks on a mission through a wormhole in search of a new home for humanity.",
    imgUrl:
  ...
  MovieModel(
    ...
    rating: 9.0,
    synopsis:
        "With Gotham under threat from the enigmatic and chaotic Joker, Batman must push his limits to save the city. As the Joker unleashes a wave of destruction, Bruce Wayne faces personal and moral dilemmas that could define his legacy.",
    imgUrl:
  ...
  MovieModel(
    ...
    rating: 8.8,
    synopsis:
        "Forrest Gump, a kind-hearted man with a low IQ, unwittingly influences some of the most significant events in American history. Through his journey he teaches those around him that success is about kindness and perseverance.",
    imgUrl:
  ...
  MovieModel(
    ...
    rating: 8.7,
    synopsis:
        "Neo, a computer hacker, discovers that the world he lives in is a simulated reality controlled by machines. He joins a rebellion to fight for the freedom of humanity.",
    imgUrl:
  ...
  MovieModel(
    ...
    rating: 9.2,
    synopsis:
        "The aging patriarch of the Corleone crime family hands over control to his reluctant son Michael. As he gets entangled in the family business, Michael transforms into a ruthless leader.",
    imgUrl:
  ...
  MovieModel(
    ...
    rating: 7.8,
    synopsis:
        "A young aristocrat falls in love with a struggling artist aboard the ill-fated Titanic. As the ship meets its tragic fate, their love is tested in the most harrowing of circumstances.",
    imgUrl:
  ...
  MovieModel(
    ...
    rating: 8.9,
    synopsis:
        "A series of interwoven stories about crime, redemption, and fate unfold in Tarantino's classic. From hitmen on a job to an aging boxer fighting for his life.",
    imgUrl:
  ...
  MovieModel(
    ...
    rating: 7.8,
    synopsis:
        "In the distant world of Pandora, a paraplegic Marine Jake Sully embarks on a mission that leads him to question his loyalties as he connects with the native Na'vi people.",
    imgUrl:
  ...
  MovieModel(
    ...
    rating: 8.8,
    synopsis:
        "A young hobbit Frodo Baggins inherits a powerful ring and must embark on a perilous journey across Middle-earth to destroy it before it falls into the hands of the dark lord Sauron.",
    imgUrl:
  ...
  MovieModel(
    ...
    rating: 8.8,
    synopsis:
        "An insomniac office worker forms an underground fight club with a charismatic soap salesman. As their violent escapades spiral out of control, he uncovers shocking truths about identity and mental illness.",
    imgUrl:
